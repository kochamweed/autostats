...
local ped = PlayerPedId()
	if IsPedInAnyVehicle(ped, false) then
		...
		TriggerEvent('chatMessage', "", {255, 0, 0}, " ^2Nazwa pojazdu:^7 ".. GetDisplayNameFromVehicleModel(model) ..
            ...
            "\r\n ^4Biegi:^7 ".. GetVehicleHighGear(veh) ..
            "\r\n ^5Miejsc:^7 ".. GetVehicleMaxNumberOfPassengers(veh) + 1)
	end
end)
